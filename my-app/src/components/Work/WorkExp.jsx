...
function Work(props) {
    ...
    return (
        <div className="w-[78%] h-auto mx-auto mt-5">
            <h2 className="text-gray-800 mt-10 text-3xl font-bold">Internship Experience</h2>
            ...
            <h2 className="text-gray-800 mt-10 text-3xl font-bold">Education</h2>
